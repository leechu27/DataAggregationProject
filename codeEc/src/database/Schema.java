...
public class Schema {
	public static String sqlUserTable = "Create Table if not exists Users(username String,password String,type int);";
	public static String sqlClientProfile = "CREATE TABLE if not exists Client_Profile (\r\n" + 
    		...
    		");\r\n" + 
    		"";
	public static String sqlLTClientEnrollNew = "CREATE TABLE if not exists LT_Client_Enroll_New (\r\n" + 
    		"    processing_details,\r\n" + 
    		"    update_record_id,\r\n" + 
    		...
    		");\r\n" + 
    		"";
	public static String sqlLTClientExitNew = "CREATE TABLE if not exists LT_Client_Exit_New (\r\n" + 
    		"    processing_details,\r\n" + 
    		"    update_record_id,\r\n" + 
    		"    client_validation_type_id,\r\n" + 
    		"    client_validation_id   PRIMARY KEY,\r\n" + 
    		...
    		");\r\n" + 
    		""; 
	public static String sqlLT_Course_Setup_New = "CREATE TABLE if not exists LT_Course_Setup_New (\r\n" + 
    		"    processing_details,\r\n" + 
    		"    update_record_id,\r\n" + 
    		"    course_cd,\r\n" + 
    		"    course_note,\r\n" + 
    		...
    		"    valid                                         BOOLEAN\r\n" + 
    		");";
	public static String sqlCommunityConnections="CREATE TABLE if not exists Community_Connections (\r\n" + 
    		"    processing_details,\r\n" + 
    		"    update_record_id,\r\n" + 
    		"    client_validation_type_id,\r\n" + 
    		"    client_validation_id   PRIMARY KEY,\r\n" + 
    		...
    		");\r\n" + 
    		"";
	public static String sqlEmployment="CREATE TABLE if not exists Employment (\r\n" + 
    		"    processing_details,\r\n" + 
    		"    update_record_id,\r\n" + 
    		"    client_validation_type_id,\r\n" + 
    		...
    		");\r\n" + 
    		"";
	public static String sqlInfoOrien="CREATE TABLE if not exists Info_Orien (\r\n" + 
    		"    processing_details,\r\n" + 
    		"    update_record_id,\r\n" + 
    		"    client_validation_type_id,\r\n" + 
    		"    client_validation_id,\r\n" + 
    		...
    		");\r\n" + 
    		"";
	public static String sqlNeedsAssessmentAndReferrals="CREATE TABLE if not exists Needs_Assessment_and_Referrals (\r\n" + 
    		"    processing_details,\r\n" + 
    		"    update_record_id,\r\n" + 
    		"    client_validation_type_id,\r\n" + 
    		"    client_validation_id,\r\n" + 
